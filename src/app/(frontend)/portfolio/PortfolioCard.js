        ...
        <>
            {
                portfolios.map((item, index) => (
                    <div className="mb-8 md:col-6 lg:col-4 integration-tab-item" key={index}>
                        <div className="rounded-xl bg-white px-10 pt-11 pb-8 shadow-lg">
                            <div className="integration-card-head flex items-center space-x-4">
                                ...
                                <div>
                                    <h4 className="h4">{item.portfolio_name}</h4>
                                    <span className="font-medium">{item.category_value}</span>
                                </div>
                            </div>
                            <div className="my-5 border-y border-border py-5">
                                <p style={ellipsis}>{item.portfolio_short_description}</p>
                            </div>
                            <Link className="inline-flex items-center font-semibold text-dark" href={`/portfolio/${item.slug}`}>
                                View Project
                                <svg
                                    className="ml-1.5"
                                    width="13"
